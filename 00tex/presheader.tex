...
%\SetWatermarkText{Copyright CBS}
...
%    \path[fill=cbsgrey, rounded corners] 
%       (current page.south east) +(-20mm,7mm ) rectangle +(0mm, 23mm);
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[xshift=7mm,yshift=5mm] at (current page.south west) {
        \includegraphics[height=10mm]{../00tex/logo.jpg}
    };
  \end{tikzpicture}
}
...
%        \includegraphics[width=2cm]{../tex/logos/EMOS-HRv2.jpg}
%    };
%    \node[xshift=2.0cm,yshift=1.1cm] at (current page.south west){
%      \includegraphics[width=3cm]{../tex/logos/academy.png}
%    };
%  \end{tikzpicture}
% let's also write our own affiliation
\textcolor{cbsgreyblue}{CBS, Department of Methodology}
}
